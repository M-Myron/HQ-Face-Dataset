...
#         print("Processing",uid)
        ...
        for id, clip in enumerate(video['clip_info']):
            ...
            if center_face == 1:
                ...
                c = max(face_w, face_h)
                face_x = (clip['bbox']['face_bbox'][2] + clip['bbox']['face_bbox'][0])/2 - (c/2)
                face_y = (clip['bbox']['face_bbox'][3] + clip['bbox']['face_bbox'][1])/2 - (c/2)
                face_w = c
                face_h = c
            else:
...
#             print(video_clip, face_x, face_y, face_w, face_h)
            ...
            face_clip = ffmpeg.output(face_clip, os.path.join(uid_dir, '%05d.jpg'))
...
#     parser.add_argument('--output_dir', type=str, default='./Pilot/crop_frames')
    parser.add_argument('--output_dir', type=str, default='../DATA/UpperBody/crop_frames')
